              ...
              <div class="row justify-content-center">
                <div class="col-lg-3 order-lg-2">
                  <div class="card-profile-image">
                    <a href="#">
                      <img src="<?php echo ($user->photo == null) ? 'assets/img/theme/user-a-min.png' : $user->photo; ?>" id="user_photo" class="rounded-circle">
                    </a>
                  </div>
                </div>
              </div>
              ...
              <div class="card-body pt-0 pt-md-4">
                ...
                <div class="text-center">
                  ...
                  <div class="form-group">
                    ...
                    <input type="file" id="input-photo" name="user_photo" class="form-control form-control-alternative">
                  </div>
                </div>
              </div>
            </div>
                    ...
                    <div class="row">
                      ...
                      <div class=" col-lg-6">
                          <div class="form-group">
                            ...
                            <input type="email" id="input-email" value="<?php echo $user->email; ?>" name="admin_email" class="form-control form-control-alternative">
                          </div>
                        </div>
                      ...
                      <div class=" row">
                        <div class=" col-lg-6">
                          <div class="form-group">
                            ...
                            <select id="input-gender" name="user_gender" class="form-control form-control-alternative">
                        ...
                        <div class=" col-lg-6">
                          <div class="form-group">
                            ...
                            <input type="phone" id="input-phone" value="<?php echo $user->phone; ?>" name="admin_email" class="form-control form-control-alternative">
                          </div>
                        </div>
                      ...
                      <div class="row">
                        <div class=" col-lg-6">
                          <div class="form-group">
                            ...
                            <textarea id="input-address" name="user_address" class="form-control form-control-alternative"><?php echo $user->address ?></textarea>
                          </div>
                        </div>
